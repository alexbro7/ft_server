...
#SSL
mkdir /etc/nginx/ssl
openssl req -newkey rsa:4096 -x509 -sha256 -days 365 -nodes -out /etc/nginx/ssl/_.pem -keyout /etc/nginx/ssl/_.key -subj "/C=FR/ST=Paris/L=Paris/O=42 School/OU=alebross/CN=_"
